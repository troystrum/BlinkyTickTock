...
void colorSetup() {
  ...
  // We want the colours to be random, but to not be too white 
  // or too dark or the triplet to be too similar. This helps
  // produce some nice bright colors that have some punch.
  //
  switch(num) {
    
  case 0: 
    randcolor1_r = random(64);
    randcolor1_g = random(128,255);
    randcolor1_b = random(255); 
    break;
    
  case 1: 
    randcolor1_r = random(255);
    randcolor1_g = random(64);
    randcolor1_b = random(128,255); 
    break;
    
  case 2: 
    randcolor1_r = random(128,255);
    randcolor1_g = random(255);
    randcolor1_b = random(64);
    break;
